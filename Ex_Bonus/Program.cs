...
Эти кусты обладают разной урожайностью, поэтому ко времени сбора н
а них выросло различное число ягод – на i-ом кусте выросло ai ягод.
...
Console.Clear();
Console.Write("Введите максимальное количестов кустов: ");
int n = Convert.ToInt32(Console.ReadLine());
Console.Write("Введите максимальное количестов ягод на одном кусте: ");
...
Console.WriteLine($"Максимальное количество ягод равно {max}.");